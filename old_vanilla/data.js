// The icons based on user's image
const ICONS = {
  python: '🐍',
  math: '∑',
  classical: '📊',
...
const PHASES=[
  {key:'python',icon:'🐍',label:'Python',stage:'Phase 0',dur:'4–6 weeks',
  ...
  {key:'math',icon:'∑',label:'Math for ML',stage:'Phase 1',dur:'6–8 weeks',
  ...
  {key:'classical',icon:'📊',label:'Classical ML',stage:'Stages 1–2',dur:'10–12 weeks',
  ...
  {key:'dl',icon:'🧠',label:'Deep Learning',stage:'Stage 3',dur:'12–16 weeks',
  ...
  {key:'fp',icon:'⚙️',label:'First Principles',stage:'Stage 4',dur:'6–8 weeks',
  ...
  {key:'spec',icon:'🎯',label:'Specialisation',stage:'Stage 5',dur:'12–16 weeks',
  ...
  {key:'llms',icon:'✨',label:'LLMs',stage:'Stage 6',dur:'10–14 weeks',
  ...
  {key:'mlops',icon:'🚀',label:'MLOps',stage:'Stage 7',dur:'8–10 weeks',
